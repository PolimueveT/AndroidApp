...
public class Portada extends ActionBarActivity implements OnClickListener {
	...
	/**
	 * Intenta conectar con el parking si el dispositivo tiene conexi贸n a
	 * internet
	 * 
	 */
	public void conectar() {
		if (isOnline()) {
			...
			Toast notification = Toast.makeText(this,
					"Activa tu conexi髇 a internet", Toast.LENGTH_SHORT);
	...
	/**
	 * Petici贸n get al servidor a la url urls[0] que recibe como par谩metro al
		...
		protected void onPostExecute(Void result) {
			...
			if (respuesta.data) {
				...
				Toast notification = Toast.makeText(Portada.this,
						"Usuario o contrase馻 incorrectos", Toast.LENGTH_SHORT);
				notification.setGravity(Gravity.CENTER, 0, 0);
				notification.show();
				// progreso.setVisibility(View.GONE);
	...
	/**
	 * Almacena en el shared preferences que se ha iniciado sesi贸n y da acceso a
	 * la aplicaci贸n
	 */
